...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, BACKLIGHT_Pin|GPIO_PIN_3|DS18B20_OW_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : BACKLIGHT_Pin PE3 */
  GPIO_InitStruct.Pin = BACKLIGHT_Pin|GPIO_PIN_3;
