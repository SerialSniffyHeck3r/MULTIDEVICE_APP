...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, BACKLIGHT_Pin|SOFT_PWR_OFF_Pin|DS18B20_OW_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : BACKLIGHT_Pin SOFT_PWR_OFF_Pin */
  GPIO_InitStruct.Pin = BACKLIGHT_Pin|SOFT_PWR_OFF_Pin;
