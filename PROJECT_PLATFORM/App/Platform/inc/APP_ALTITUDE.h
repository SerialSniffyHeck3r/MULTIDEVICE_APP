...
/* -------------------------------------------------------------------------- */
/*  상위 VARIO 앱의 고급 audio filter 결과를 저수준 debug audio transport로    */
/*  넘기는 override API                                                       */
/*                                                                            */
/*  valid = true  : vario_cms 값을 실제 tone source로 사용                    */
/*  valid = false : override를 해제하고 내부 fast-vario source로 복귀          */
/* -------------------------------------------------------------------------- */
