...
void Motor_UI_ConfigureBottomBar(const motor_state_t *state)
{
    ...
    case MOTOR_SCREEN_VEHICLE_SUMMARY:
        UI_BottomBar_SetButton(UI_FKEY_1, "HOME", UI_BOTTOMBAR_FLAG_DIVIDER);
        UI_BottomBar_SetButton(UI_FKEY_2, "FIELD", UI_BOTTOMBAR_FLAG_DIVIDER);
        UI_BottomBar_SetButton(UI_FKEY_3, "PAGE", UI_BOTTOMBAR_FLAG_DIVIDER);
        UI_BottomBar_SetButton(UI_FKEY_4, "PEAK", UI_BOTTOMBAR_FLAG_DIVIDER);
        UI_BottomBar_SetButton(UI_FKEY_5, "SET", UI_BOTTOMBAR_FLAG_DIVIDER);
        UI_BottomBar_SetButton(UI_FKEY_6, "REC", 0u);
        break;
